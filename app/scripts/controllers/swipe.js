...
angular.module('scribeApp').directive('myRepeatDirective', function () {
    ...
    $scope.fillPreferencesList = function (listType) {
        ...
        for (var i = 0; i < selectedList.length; i++) {
            ...
            selectedCard += "<div class='col-xs-6 col-sm-4'>" + "<div class='list-card'>" + "<div class='content-image'>" + "<img src='" + selectedList[i].imagen + "' alt=''></div>" + "<div class='detail-card'><p class='card-name'>" + selectedList[i].nombre + "</p>" + "<div class='like-count'>" + "<span class='counter'>" + selectedList[i].like + "</span>" + "<div class='like-btn'></div></div>" + "</div>" + "</div>" + "</div>";
